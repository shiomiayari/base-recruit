        ...
        >
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-10 py-4 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 font-bold rounded-full transition-shadow hover:shadow-2xl hover:shadow-blue-500/20 text-center w-full sm:w-auto"
            >
              ENTRY
            </motion.a>
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-10 py-4 bg-transparent border-2 border-zinc-900 dark:border-white text-zinc-900 dark:text-white font-bold rounded-full transition-all hover:bg-zinc-900 hover:text-white dark:hover:bg-white dark:hover:text-zinc-900 text-center w-full sm:w-auto"
            >
              ABOUT US
            </motion.a>
          </div>
